...
class UserInfo(models.Model):
    ...
    cid = models.ForeignKey('ClassInfo', on_delete=models.SET_NULL, null=True, blank=True)
    nickname = models.CharField(max_length=30, null=True)
    major = models.ForeignKey('MajorInfo', on_delete=models.SET_NULL, null=True, blank=True)
    hobby = models.CharField(max_length=30, null=True)
    age = models.IntegerField(null=True)
    user_type = models.ForeignKey(to='UserType', on_delete=models.SET_NULL, null=True, blank=True)
...
class Attendence(models.Model):
    ...
    stu = models.ForeignKey('UserInfo', on_delete=models.SET_NULL, null=True, blank=True)      # 外键问题，删除后为null
...
class Notice(models.Model):
    ...
    author = models.ForeignKey('UserInfo', on_delete=models.SET_NULL, null=True, blank=True)
...
class Leave(models.Model):
    ...
    user = models.ForeignKey(to='UserInfo', on_delete=models.SET_NULL, null=True, blank=True)
...
#     content = models.ForeignKey(to='ExamContent', on_delete=models.SET_NULL, null=True, blank=True)
